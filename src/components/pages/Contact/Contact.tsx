    ...
    <div className="flex flex-col px-[15dvw] md:px-[10dvw] py-[15dvh] w-full min-h-dvh font-space-grotesk font-bold">
      ...
      <div className="flex md:flex-row flex-col w-full">
        <div className="flex flex-col justify-between w-full md:w-1/2 min-h-[30dvh]">
          <div>
            <h2 className="mb-8 font-bold text-text-primary/70 text-2xl md:text-6xl leading-tight">
              <AnimateString delayOffset={0.05}>Let's connect.</AnimateString>
            </h2>

            <div className="space-y-2">
              <p className="font-mono text-text-primary/50 text-xs uppercase tracking-widest">
              ...
              <a
                ...
                className="group flex items-center gap-2 font-medium text-text-primary/90 hover:text-zinc-400 text-sm md:text-2xl transition-colors"
              >
