...
const Contact = () => {
  return (
    <div className="flex md:flex-row flex-col px-[15dvw] md:px-[10dvw] py-[15dvh] w-full min-h-dvh font-space-grotesk font-bold">
      ...
      <div className="flex flex-col justify-between w-full md:w-1/2 min-h-[30dvh]">
        ...
        <div className="flex flex-col gap-8 mt-12 md:mt-0">
          ...
          <div className="space-y-1">
            <p className="font-mono text-primary/50 text-xs uppercase tracking-widest">Location</p>
